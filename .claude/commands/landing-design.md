...
## Context
- PROJECT FOLDERS: the convention in CLAUDE.md
...
- The team playbooks live in .claude/skills/ui-*/ — follow them in order:
  intelligence, creative-director, copywriter, brand-analyzer, designer,
  design-guide, builder.
