...
1. tech-architect (.claude/skills/tech-bridge-tech-architect/): read the project brief (knowledge-base/briefs/<projekt-slug>/;
   the folder convention is in CLAUDE.md)
...
7. If FAIL: run the self-healing loop (see .claude/skills/tech-bridge-qa/SKILL.md).
